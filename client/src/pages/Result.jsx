      ...
      <div className='bg-[#f9f8e6] rounded-lg px-8 py-6 drop-shadow-sm'>
        <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
          <div>
            ...
            <img className="rounded-md border" src={kianu} alt="photo with background"/>
          </div>
          ...
          <div className='flex flex-col'>
           ...
           {/* <img src={kianu2} alt="photo with no background" />*/}

            <div className='absolute right-1/2 bottton-1/2 transform translate-x-1/2 translate-y-1/2'>
        ...
        <div className='flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
          ...
          <a className='px-8 py-2.5 text-white text-sm bg-gradient-to-r from-[#65c4f0] to-[#bd8803] rounded-full hover:scale-105 transition-all duration-300' href=''>Download image</a>
        </div>
